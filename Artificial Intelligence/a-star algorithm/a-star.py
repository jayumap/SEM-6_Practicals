...
def astar_search(problem):  # based on fig 3.24
    ...
    while nodelist:
        ...
        print("min dist" , min_dist , "closest dist", closest_node )
...
# romania_map.locations = {'Arad': (91, 492), 'Bucharest': (400, 327), 'Craiova': (253, 288),
#                              'Drobeta': (165, 299), 'Eforie': (562, 293), 'Fagaras': (305, 449),
#                              'Giurgiu': (375, 270), 'Hirsova': (534, 350), 'Iasi': (473, 506),
#                              'Lugoj': (165, 379), 'Mehadia': (168, 339), 'Neamt': (406, 537),
#                              'Oradea': (131, 571), 'Pitesti': (320, 368), 'Rimnicu': (233, 410),
...
def solve_prof(src, dist):
    print("\nSolving for "+src + " to " + dist+ "...")

    problem = GraphProblem(src, dist, romania_map)
    resultnode = astar_search(problem)

    print("Path taken :", resultnode.path())
    print("Path Cost :", resultnode.path_cost)

solve_prof('Arad', 'Bucharest')
